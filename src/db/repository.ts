    ...
    return {
      ...
      clientBillingPlans: [
        ...
        },
        {
          ...
          billingPeriodId: periodSepC1Id,
          grossBillingAmount: '15000.00',
          notes: 'Cycle 1 (Sep 1-15) billing (₹30k monthly split into 2 cycles)',
          createdByPartnerId: anuragId,
          updatedByPartnerId: anuragId,
          createdAt: '2026-09-01T00:00:00Z',
          updatedAt: '2026-09-01T00:00:00Z',
        },
        {
          ...
          billingPeriodId: periodSepC1Id,
          grossBillingAmount: '20000.00',
          notes: 'Cycle 1 (Sep 1-15) billing (₹40k monthly split into 2 cycles)',
          createdByPartnerId: anuragId,
          updatedByPartnerId: anuragId,
          createdAt: '2026-09-01T00:00:00Z',
          updatedAt: '2026-09-01T00:00:00Z',
        ...
        },
        {
          ...
          billingPeriodId: periodSepC2Id,
          grossBillingAmount: '15000.00',
          notes: 'Cycle 2 (Sep 16-30) billing (₹30k monthly split into 2 cycles)',
          createdByPartnerId: anuragId,
          updatedByPartnerId: anuragId,
          createdAt: '2026-09-16T00:00:00Z',
          updatedAt: '2026-09-16T00:00:00Z',
        },
        {
          ...
          billingPeriodId: periodSepC2Id,
          grossBillingAmount: '20000.00',
          notes: 'Cycle 2 (Sep 16-30) billing (₹40k monthly split into 2 cycles)',
          createdByPartnerId: anuragId,
          updatedByPartnerId: anuragId,
          createdAt: '2026-09-16T00:00:00Z',
          updatedAt: '2026-09-16T00:00:00Z',
        ...
        },
        {
          ...
          notes: 'Total project billing ₹30,000 (₹15k Cycle 1 + ₹15k Cycle 2)',
          createdByPartnerId: anuragId,
          updatedByPartnerId: anuragId,
          createdAt: '2026-09-01T00:00:00Z',
          updatedAt: '2026-09-01T00:00:00Z',
        },
        {
          ...
          billingPeriodId: periodSepId,
          grossBillingAmount: '40000.00',
          notes: 'Total billing ₹40,000 (₹20k Cycle 1 + ₹20k Cycle 2)',
          createdByPartnerId: anuragId,
          updatedByPartnerId: anuragId,
          createdAt: '2026-09-01T00:00:00Z',
          updatedAt: '2026-09-01T00:00:00Z',
      ...
      clientPayments: [
        ...
        // Sai August 16-31 (Received by Vivek)
        {
          id: 'pay-aug-sai-c2',
          billingPlanId: 'cbp-sai-aug-c2',
          collectedByPartnerId: vivekId,
          paymentDate: '2026-08-31',
          amountReceived: '20000.00',
          paymentReference: 'SAI-AUG-C2',
          status: 'CONFIRMED',
          notes: 'August 16-31 payment received by Vivek',
          idempotencyKey: 'idem-sai-aug-c2',
          createdByPartnerId: vivekId,
          createdAt: '2026-08-31T10:00:00Z',
          updatedAt: '2026-08-31T10:00:00Z',
        },
        {
          id: 'pay-aug-sai-full2',
          billingPlanId: 'cbp-sai-aug',
          collectedByPartnerId: vivekId,
          paymentDate: '2026-08-31',
          amountReceived: '20000.00',
          paymentReference: 'SAI-AUG-16-31-FULL',
          status: 'CONFIRMED',
          notes: 'August 16-31 payment received by Vivek',
          idempotencyKey: 'idem-sai-aug-full2',
          createdByPartnerId: vivekId,
          createdAt: '2026-08-31T10:00:00Z',
          updatedAt: '2026-08-31T10:00:00Z',
        },
        // Rohit September 1-15 (Received by Vivek)
        {
          id: 'pay-sep-rohit-c1',
          billingPlanId: 'cbp-rohit-sep-c1',
          collectedByPartnerId: vivekId,
          paymentDate: '2026-09-05',
          amountReceived: '20000.00',
          paymentReference: 'ROHIT-SEP-C1',
          status: 'CONFIRMED',
          notes: 'Sep 1-15 payment received by Vivek',
          idempotencyKey: 'idem-rohit-sep-c1',
          createdByPartnerId: vivekId,
        ...
        // Sai September 1-15 (Received by Anurag)
        {
          ...
          status: 'CONFIRMED',
          notes: 'Sep 1-15 payment received by Anurag',
        ...
        {
          id: 'pay-sep-sai-full1',
          billingPlanId: 'cbp-sai-sep',
          collectedByPartnerId: anuragId,
          paymentDate: '2026-09-11',
          amountReceived: '25000.00',
          paymentReference: 'SAI-SEP-FULL-P1',
          status: 'CONFIRMED',
          notes: 'Sep 1-15 payment received by Anurag',
          idempotencyKey: 'idem-sai-sep-full1',
          createdByPartnerId: anuragId,
          createdAt: '2026-09-11T10:00:00Z',
          updatedAt: '2026-09-11T10:00:00Z',
        },
